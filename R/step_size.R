...
#' Note: arguments passed to osam for adaptation are not used here.
#' 
...
init_stepsize = function(U, grad, pos0, tau0, w0, h0 = 1) {
  ...
  Delta = osam(U, grad, pos0, tau0, h0, w0, m_dummy, iter = 1,
               H_bar = 0, h_bar = 0, mu = 0, n_warmup = 0, delta = 0.8)$Delta
